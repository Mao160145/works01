...
public class CmsPositionVo {
    ...
    public void setCompany_balance(int company_balance) {
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("CmsPositionVo{");
        ...
        sb.append(", company_balance=").append(company_balance);
        sb.append('}');
        return sb.toString();
    }
}
